...
if(isset($_POST["proses"]))
{
	...
	$ambil= $koneksi->query("SELECT * FROM nota_setor JOIN akun ON nota_setor.ID_Akun = akun.ID_Akun WHERE nota_setor.ID_Statussetor='SS000001' AND Tanggal_setor BETWEEN '$tgl_mulai' AND'$tgl_selesai'");
...
<center><h3> Laporan Transaksi Setor dari <?php echo $tgl_mulai?> hingga <?php echo $tgl_selesai?> <?php echo $cabangbank?></h3>
</center><hr>
	<form method="post">
		<div class="row">
			<div class="col-md-3">
			...
			<div class="col-md-1">
				...
				<div class="col-md-1">
      				<div class="form-group">
      					<label>&nbsp;</label> 
        				<a href="index.php?halaman=semualaporantransaksisetor" class="btn btn-warning square-btn-adjust"><i class="fa fa-folder-open-o"></i> Lihat Semua Laporan
        			</a>
      			</div> 
      		</div>  
		</div>
...
<thead>
    <a href="index.php?halaman=laporanmembersetor" class="btn btn-success square-btn-adjust" style="margin-bottom:16px"><i class="fa fa-refresh"></i> Refresh </a> 
...
?>
	<script language="JavaScript">
        ...
        document.location='index.php?halaman=laporantransaksisetor';
    </script>	
...
?>
	<br>
<?php
	$ambil= mysqli_query ($koneksi,"SELECT *, count(akun.ID_Akun) AS jumlah_setor_akun FROM nota_setor 
	INNER JOIN akun ON nota_setor.ID_Akun = akun.ID_Akun  JOIN cabang_bank_sampah
            ON nota_setor.ID_Cabang_Bank=cabang_bank_sampah.ID_Cabang_Bank
	WHERE nota_setor.ID_Statussetor='SS000001' AND Tanggal_setor BETWEEN '$dt1' AND'$dt2' AND Nama_Bank='$cabangbank' GROUP BY nota_setor.ID_Akun ORDER BY jumlah_setor_akun DESC LIMIT 5");
	}
?>
        <?php
        $nomor=1;
        ...
        <tr>        
            ...
            <td><?php echo $pecah['jumlah_setor_akun']; ?></td>                  
                </tr>
              <?php $nomor++ ?>
              <?php } ?>
            </tbody>
