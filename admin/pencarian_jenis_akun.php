...
$query=mysqli_query($koneksi, "SELECT * FROM jenis_akun WHERE ID_jenis_akun LIKE '%$keyword%' OR jenis_akun LIKE '%$keyword%'")
...
<form class="form-horizontal" role="search" method="post" action="index.php?halaman=pencarianjenisakun">
  ...
  <tbody>
    <?php $nomor=1;?>
    <?php $ambil=$koneksi->query("SELECT * FROM jenis_akun WHERE ID_jenis_akun LIKE '%$keyword%' OR jenis_akun LIKE '%$keyword%'");?>
    ...
    <tr>
      ...
      <td> 
        <a href="index.php?halaman=hapusjenisakun<?php echo $pecah['ID_jenis_akun'];?>" class="btn-danger btn" >Hapus</a>
        <a href="index.php?halaman=ubahjenisakun<?php echo $pecah['ID_jenis_akun'];?>" class="btn btn-warning"> Ubah </a>
      </td>
    </tr>
    <?php $nomor++; ?>
    <?php } ?>
