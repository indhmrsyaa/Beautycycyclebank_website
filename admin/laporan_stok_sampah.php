...
<i><b><h5> Berdasarkan : </h5></b></i>
                   <form method="post">
                   <input type="radio" name="sampah"/> Sampah
    ...
    if(isset($_POST["tampil"]))
    {
      ...
      {
          echo "<script>location='index.php?halaman=laporanstoksampahberdasarkancabangbank';</script>"; 
      }
      if(isset($_POST["sampah"]))
      {
          echo "<script>location='index.php?halaman=laporancabangbankberdasarkanberattotalsampah';</script>"; 
      }
      elseif(isset($_POST["kota"]))
      {
          echo "<script>location='index.php?halaman=laporanstoksampahberdasarkankota';</script>"; 
      }
      elseif(isset($_POST["provinsi"]))
      {
          echo "<script>location='index.php?halaman=laporanstoksampahberdasarkanprovinsi';</script>"; 
      }
     }
