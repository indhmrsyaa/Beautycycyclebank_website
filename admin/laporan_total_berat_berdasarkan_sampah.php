...
<?php
   ...
   WHERE Nama_Sampah='$_POST[ID_Sampah]' AND nota_setor.ID_Statussetor='SS000001' AND Tanggal_setor BETWEEN '$dt1' AND'$dt2' GROUP BY sampah.ID_Sampah ORDER BY Sub_Total DESC LIMIT 5");
	}
?>
