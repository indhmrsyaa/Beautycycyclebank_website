...
if(isset($_POST["proses"]))
{
   ...
   INNER JOIN sampah ON transaksi_setor.ID_Sampah = sampah.ID_Sampah JOIN jenis_sampah ON sampah.ID_Jenis_Sampah=jenis_sampah.ID_Jenis_Sampah JOIN jenis_satuan ON sampah.ID_Satuan=jenis_satuan.ID_Satuan
   INNER JOIN nota_setor ON transaksi_setor.ID_Nota_Setor=nota_setor.ID_Nota_Setor JOIN cabang_bank_sampah ON nota_setor.ID_Cabang_Bank=cabang_bank_sampah.ID_Cabang_Bank 
...
<center><h3> Laporan Total Berat Berdasarkan Sampah dari <?php echo $tgl_mulai?> hingga <?php echo $tgl_selesai?></h3>
</center><hr>
	<form method="post">
		<div class="row">
			<div class="col-md-3">
			...
			<div class="col-md-2">
				<div class="form-group">
					...
					<select class="form-control" name="ID_Sampah">
						<option value="jenis_sampah">--Pilih Sampah--</option>
...
<!-- End Navbar -->
    <div class="card shadow" style="margin-top:22px">
      <div class="card-header border-4">        
        <h4 class="mb-0">Tabel Laporan Total Berat Berdasarkan Sampah</h4>
      </div>
  <div class="card-body" style="margin-top:-1px">
  <table id="datatablesSimple" class="table table-bordered border-dark" background="">
  <thead>
    <a href="index.php?halaman=laporantotalberatberdasarkansampah" class="btn btn-success square-btn-adjust" style="margin-bottom:16px"><i class="fa fa-refresh"></i> Refresh </a> 
...
?>
	<script language="JavaScript">
        ...
        document.location='index.php?halaman=laporantotalberatdansampahterbanyak';
    </script>	
...
<?php
   ...
   WHERE Nama_Sampah='$_POST[ID_Sampah]' AND nota_setor.ID_Statussetor='SS000001' AND Tanggal_setor BETWEEN '$dt1' AND'$dt2' GROUP BY cabang_bank_sampah.ID_Cabang_Bank ORDER BY Sub_Total DESC LIMIT 5");
	}
?>
