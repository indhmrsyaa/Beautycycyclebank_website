...
$query=mysqli_query($koneksi, "SELECT * FROM kota WHERE ID_Kota LIKE '%$keyword%' OR Nama_kota LIKE '%$keyword%'")
...
<div class="container-fluid px-4">
    <h1 class="mt-4">Nama Kota</h1>
      <ol class="breadcrumb mt-2 bg-transparent">
        <li  class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
          <li class="breadcrumb-item active">Nama Kota</li>
      </ol>
<form class="form-horizontal" role="search" method="post" action="index.php?halaman=pencarianjenisakun">
  <div class="row">
    ...
    <div class="card shadow" style="margin-top:22px">
      <div class="card-header border-4">        
        <h4 class="mb-0">Tabel Nama Kota</h4>
      </div>
  ...
  <tbody>
    <?php $nomor=1;?>
    <?php $ambil=$koneksi->query("SELECT * FROM kota WHERE ID_Kota LIKE '%$keyword%' OR Nama_kota LIKE '%$keyword%'");?>
    ...
    <tr>
      ...
      <td> 
        <a href="index.php?halaman=hapuskota<?php echo $pecah['ID_Kota'];?>" class="btn-danger btn" >Hapus</a>
        <a href="index.php?halaman=ubahkota<?php echo $pecah['ID_Kota'];?>" class="btn btn-warning"> Ubah </a>
      </td>
    </tr>
    <?php $nomor++; ?>
    <?php } ?>
