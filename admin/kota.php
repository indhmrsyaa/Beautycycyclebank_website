...
<form class="form-horizontal" role="search" method="post" action="index.php?halaman=pencariankota">
  <div class="row">
      <div class="col-md-3">
        <div class="form-group">
          <input type="text" class="form-control" name="keyword" placeholder="Masukkan Kota" autofocus autocomplete="off">
        </div> 
    </div>
    <div class="col-md-2">
      <div class="form-group">
    ...
    <div class="card shadow" style="margin-top:22px">
      <div class="card-header border-4">        
        <h4 class="mb-0">Tabel Kota</h4>
      </div>
  <div class="card-body" style="margin-top:-1px">
  <table id="datatablesSimple" class="table table-bordered border-dark" background="">
  <thead>
    <a href="index.php?halaman=kota" class="btn btn-success square-btn-adjust" style="margin-bottom:16px"><i class="fa fa-refresh"></i> Refresh </a> 
  ...
  <tbody>
    ...
    <tr>
      ...
      <td> 
        <a href="index.php?halaman=hapuskota&id=<?php echo $pecah['ID_Kota'];?>" class="btn-danger btn" >Hapus</a>
        <a href="index.php?halaman=ubahkota&id=<?php echo $pecah['ID_Kota'];?>" class="btn btn-warning"> Ubah </a>
      </td>
    </tr>
    <?php $nomor++; ?>
    <?php } ?>
...
<a href="index.php?halaman=tambahkota" class ="btn btn-primary"> Tambah </a>
