...
<div class="container-fluid px-4">
    <h1 class="mt-4">Laporan Total Hadiah Klaim</h1>
      <ol class="breadcrumb mt-2 bg-transparent">
        <li  class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
          <li class="breadcrumb-item active">Laporan Total Hadiah Klaim</li>
      </ol>
    <div class="card shadow" style="margin-top:22px">
      <div class="card-header border-4">        
        <h4 class="mb-0">Tabel Laporan Total Hadiah Klaim</h4>
      </div>
...
<table id="datatablesSimple" class="table table-bordered border-dark" background="">
  ...
  <div class="form-group">
      				<label>&nbsp;</label> 
        			<a href="index.php?halaman=semualaporantotalhadiah" class="btn btn-warning square-btn-adjust"><i class="fa fa-folder-open-o"></i> Lihat Semua Total Hadiah
        			</a>
  ...
  <thead>
    ...
    <tbody>
      ...
      AS Total_Transaksi_Gift FROM transaksi_gift 
      ...
      ON nota_gift.ID_Statusklaim=status_klaim.ID_Statusklaim 
      WHERE nota_gift.ID_Statusklaim='SK000001' GROUP BY cabang_bank_sampah.ID_Cabang_Bank ORDER BY QTY DESC LIMIT 5");?>
