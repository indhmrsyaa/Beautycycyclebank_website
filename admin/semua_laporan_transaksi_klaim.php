...
<div class="container-fluid px-4">
    <h1 class="mt-4">Laporan Member Klaim</h1>
      <ol class="breadcrumb mt-2 bg-transparent">
        <li  class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
          <li class="breadcrumb-item active">Laporan Member Klaim</li>
      </ol>
...
<thead>
    <a href="index.php?halaman=semualaporanmemberklaim" class="btn btn-success square-btn-adjust" style="margin-bottom:16px"><i class="fa fa-refresh"></i> Refresh </a> 
...
<tbody>
        ...
        INNER JOIN akun ON nota_gift.ID_akun = akun.ID_akun WHERE nota_gift.ID_Statusklaim='SK000001' GROUP BY nota_gift.ID_akun ORDER BY jumlah_klaim_akun DESC LIMIT 5");
