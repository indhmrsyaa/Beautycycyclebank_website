...
$query=mysqli_query($koneksi, "SELECT * FROM provinsi WHERE ID_Provinsi LIKE '%$keyword%' OR Nama_Provinsi LIKE '%$keyword%'")
...
<div class="container-fluid px-4">
    <h1 class="mt-4">Nama provinsi</h1>
      <ol class="breadcrumb mt-2 bg-transparent">
        <li  class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
          <li class="breadcrumb-item active">Nama provinsi</li>
      </ol>
<form class="form-horizontal" role="search" method="post" action="index.php?halaman=pencarianjenisakun">
  <div class="row">
    ...
    <div class="card shadow" style="margin-top:22px">
      <div class="card-header border-4">        
        <h4 class="mb-0">Tabel Nama Provinsi</h4>
      </div>
  ...
  <tbody>
    <?php $nomor=1;?>
    <?php $ambil=$koneksi->query("SELECT * FROM provinsi WHERE ID_Provinsi LIKE '%$keyword%' OR Nama_Provinsi LIKE '%$keyword%'");?>
    ...
    <tr>
      ...
      <td> 
        <a href="index.php?halaman=hapusprovinsi<?php echo $pecah['ID_Provinsi'];?>" class="btn-danger btn" >Hapus</a>
        <a href="index.php?halaman=ubahprovinsi<?php echo $pecah['ID_Provinsi'];?>" class="btn btn-warning"> Ubah </a>
      </td>
    </tr>
    <?php $nomor++; ?>
    <?php } ?>
...
<a href="index.php?halaman=tambahprovinsi" class ="btn btn-primary"> Tambah </a>
