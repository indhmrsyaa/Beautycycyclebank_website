...
<div class="container-fluid px-4">
    <h1 class="mt-4">Laporan Total Berat Berdasarkan Jenis Sampah</h1>
      <ol class="breadcrumb mt-2 bg-transparent">
        <li  class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
          <li class="breadcrumb-item active">Laporan Total Berat Berdasarkan Jenis Sampah</li>
      </ol>
  ...
  <thead>
    <a href="index.php?halaman=semualaporantotalberatberdasarkanjenissampah" class="btn btn-success square-btn-adjust" style="margin-bottom:16px"><i class="fa fa-refresh"></i> Refresh </a> 
    ...
    <tbody>     
      ...
      <?php $nomor=1; ?>
      <?php $ambil=$koneksi->query("SELECT *, sum(Sub_Total) AS Sub_Total, count(transaksi_setor.ID_Nota_Setor) AS Total_Transaksi_Setor FROM transaksi_setor 
      ...
      WHERE nota_setor.ID_Statussetor='SS000001' GROUP BY jenis_sampah.ID_Jenis_Sampah ORDER BY Sub_Total DESC LIMIT 5");?>
