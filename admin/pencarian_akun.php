...
$query=mysqli_query($koneksi, "SELECT * FROM akun JOIN jenis_akun ON akun.ID_jenis_akun=jenis_akun.ID_jenis_akun WHERE ID_Akun LIKE '%$keyword%' OR Nama_Lengkap LIKE '%$keyword%' OR Email LIKE '%$keyword%' OR Alamat_Rumah LIKE '%$keyword%' OR jenis_akun LIKE '%$keyword%'")
?>
...
<div class="card shadow" style="margin-top:22px">
  ...
  <tbody>
    <?php $nomor=1;?>
    <?php $ambil=$koneksi->query("SELECT * FROM akun JOIN jenis_akun ON akun.ID_jenis_akun=jenis_akun.ID_jenis_akun WHERE ID_Akun LIKE '%$keyword%' OR Nama_Lengkap LIKE '%$keyword%' OR Email LIKE '%$keyword%' OR Alamat_Rumah LIKE '%$keyword%' OR jenis_akun LIKE '%$keyword%'");?>
