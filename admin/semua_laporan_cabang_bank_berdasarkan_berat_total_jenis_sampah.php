...
<div class="container-fluid px-4">
    <h1 class="mt-4">Laporan Cabang Bank Berdasarkan Total Jenis Sampah</h1>
      <ol class="breadcrumb mt-2 bg-transparent">
        <li  class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
          <li class="breadcrumb-item active">Laporan Cabang Bank Berdasarkan Total Jenis Sampah</li>
      </ol>
    <div class="card shadow" style="margin-top:22px">
      <div class="card-header border-4">        
        <h4 class="mb-0">Tabel Laporan Cabang Bank Berdasarkan Total Jenis Sampah</h4>
      </div>
  <div class="card-body" style="margin-top:-1px">
  <table id="datatablesSimple" class="table table-bordered border-dark" background="">
  <thead>
    <a href="index.php?halaman=semualaporancabangbankberdasarkantotaljenissampah" class="btn btn-success square-btn-adjust" style="margin-bottom:16px"><i class="fa fa-refresh"></i> Refresh </a> 
