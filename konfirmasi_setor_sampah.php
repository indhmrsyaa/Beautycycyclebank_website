...
<?php //include 'menu.php'; ?>
	...
	<?php endif ?>		
		...
		<form method="post" enctype="multipart/form-data">
			<div class="form-group">
				...
				<input type="text" name="nama" class="form-control" readonly value ="<?php echo $_SESSION["member"]["Nama_Lengkap"];?>"></input>
			</div>
			<div class="form-group">
	...
	<?php 
		if(isset($_POST["kirim"]))
		{
			...
			move_uploaded_file($lokasibukti, "Bukti_Penyetoran/$nama");
			$Tanggal_Penyetoran = date("l, Y-m-d");
			$koneksi->query("UPDATE nota_setor SET Bukti_Penyetoran='$nama',Tanggal_Penyetoran='$Tanggal_Penyetoran' WHERE ID_Notasetor='$idmem'");
			//$koneksi->query("UPDATE nota_setor SET Kode_Statbayar='SB003' WHERE Kode_Faktur='$idmem'");
			$koneksi->query("UPDATE nota_setor SET ID_Statussetor='SS000001' WHERE ID_Notasetor='$idmem'");
			$koneksi->query("UPDATE nota_setor JOIN member ON nota_setor.ID_Member=member.ID_Member SET Total_Poin=Total_Poin+Penambahan_Poin WHERE ID_Notasetor='$idmem'");
